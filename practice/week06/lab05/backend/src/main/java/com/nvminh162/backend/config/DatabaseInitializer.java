package com.nvminh162.backend.config;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (count == null || count == 0) {
            jdbcTemplate.execute("INSERT INTO product (name, description) VALUES " +
        ...
        jdbcTemplate.execute("DROP PROCEDURE IF EXISTS search_products");
        ...
        System.out.println("Database Initialized Successfully with Stored Procedure.");
    }
}
