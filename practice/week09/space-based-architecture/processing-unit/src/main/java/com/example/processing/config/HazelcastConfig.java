...
/**
 * Configuração do Hazelcast para o Processing Unit.
 * Configura o cluster distribuído em memória para armazenar pedidos.
 */
@Configuration
public class HazelcastConfig {
    ...
    public HazelcastInstance hazelcastInstance() {
        ...
        clientConfig.setInstanceName("processing-client-" + System.currentTimeMillis());
